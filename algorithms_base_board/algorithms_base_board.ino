...
void loop() {
    ...
    //debug
    Serial.print("piexls[0-4]: ");
    Frame frame(MLX90641To);
    for(int i = 0;i<=4;i++){
      Serial.print(frame.piexls[i]);
    }
    Serial.println();
    Serial.print("time: ");
    Serial.println(track.time);
...
//            //debug
//            Serial.print("index_list");
//            for(int i=0;i<=frame.index.size()-1;i++){
//                Serial.print(frame.index[i]);
//            }
//            Serial.println(" ");
//            
//            //debug
